...
export default function DistributionGuide() {
  return (
    <LegalPageShell title="Distribution Guide" icon="🗺️">
      <p className="text-muted-foreground text-sm leading-relaxed mb-10">
        Follow these steps to go from signup to your first sale on Chosen One
        Distribution. This guide covers everything — account setup, uploading,
        pricing, publishing, catalog management, and getting paid.
      </p>
        ...
        {STEPS.map((s) => (
          ...
          >
            <div className="shrink-0 flex flex-col items-center">
              <div className="w-10 h-10 rounded-full bg-primary/15 border border-primary/30 flex items-center justify-center font-display font-bold text-primary text-sm">
                {s.step}
              </div>
              {s.step < STEPS.length && (
      ...
      <div className="mt-8 p-6 rounded-xl border border-primary/30 bg-primary/5">
        ...
        <p className="text-muted-foreground text-sm mb-4">
          Ready to start? Head to the upload page and drop your first track.
        </p>
