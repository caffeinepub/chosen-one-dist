  ...
  },
  {
    ...
    a: (
      <span>
        ...
        with your artist name, the track title, and the sale date. We'll review
...
export default function RoyaltyFAQ() {
  return (
    <LegalPageShell title="Royalty FAQ" icon="💎">
      <p className="text-muted-foreground text-sm leading-relaxed mb-8">
        Common questions about how royalties work on Chosen One Distribution —
        from the 85% split to payout schedules, banking requirements, and
        international transfers. For the full policy, see our{" "}
      ...
      <div className="p-6 rounded-xl border border-primary/30 bg-primary/5 text-center">
        <p className="text-foreground font-medium mb-2">
          Still have royalty questions?
        </p>
        <p className="text-muted-foreground text-sm mb-4">
          Read the full Royalty Policy or contact us directly.
        </p>
