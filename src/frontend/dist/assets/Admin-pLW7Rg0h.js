import { t as createLucideIcon, u as useTranslation, c as useActor, r as reactExports, l as ue, O as ArtistStatus, j as jsxRuntimeExports, I as Input, B as Button, o as Separator, A as hashPin, e as useQuery, f as createActor } from "./index-DkJerdwd.js";
import { B as Badge } from "./badge-DHFyt5Sg.js";
import { S as Skeleton } from "./skeleton-B5my5CIz.js";
import { S as Shield, U as Users } from "./users-CtAMD3us.js";
import { L as Lock } from "./lock-CY3ETy0P.js";
import { K as KeyRound } from "./key-round-CEYxWWyj.js";
import { C as CircleCheck } from "./circle-check-BPRA0Sxx.js";
import { R as RefreshCw } from "./refresh-cw-BtBv3zO8.js";
import { T as Trash2 } from "./trash-2-q0bt8BHE.js";
import { C as CreditCard } from "./credit-card-qLPkhsTV.js";
/**
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSave, className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "label",
                {
                  ...
                  children: [
                    "Allowed Countries",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-normal", children: "(optional — leave blank for all countries)" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1.5", children: [
                "Leave blank to support every country worldwide (recommended). Or enter comma-separated ISO codes (e.g.",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-muted/40 px-1 rounded", children: "US,CA,GB" }),
                ") to restrict."
              ] })
            ] }),
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm mb-5 leading-relaxed", children: [
                  "Use this tab",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "only if you have never set an admin PIN before" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSetInitialPIN, className: "space-y-4", children: [
                  ...
                  setInitialPinError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 text-destructive text-sm bg-destructive/10 border border-destructive/20 rounded-lg px-3 py-2.5", children: [
                    ...
                    setInitialPinError.includes("Sign In") && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
