import { h as useNavigate, c as useActor, d as useAuth, i as useCartStore, r as reactExports, v as useSearch, l as ue, j as jsxRuntimeExports, B as Button, m as ShoppingCart, L as Link, o as Separator, X, I as Input, D as Download, R as Receipt, f as createActor } from "./index-DkJerdwd.js";
import { B as Badge } from "./badge-DHFyt5Sg.js";
import { L as Label } from "./label-CvgpiRfx.js";
import { u as useCustomerAuth, h as hashPin } from "./use-customer-auth-DHpH6Yeu.js";
...
import { U as UserPlus } from "./user-plus-BX6Otnuz.js";
import { C as CircleAlert } from "./circle-alert-BxvC-4K2.js";
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Downloads starting automatically — click any button below if needed" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 space-y-3", children: tracks.map((t) => {
                const ext = t.format ?? (t.audioFileUrl ? getFileExtension(t.audioFileUrl) : "mp3");
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  t.audioFileUrl ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground max-w-[120px] leading-tight", children: [
                      'Contact support with track: "',
                      t.title,
                      '"'
                    ] })
                  ] })
  ...
  const processPayment = async () => {
    ...
    try {
      ...
      const tracksSnapshot = cartItems.map((i) => {
        var _a, _b;
        const audioFileUrl = ((_b = (_a = i.track.audioFile) == null ? void 0 : _a.getDirectURL) == null ? void 0 : _b.call(_a)) ?? void 0;
