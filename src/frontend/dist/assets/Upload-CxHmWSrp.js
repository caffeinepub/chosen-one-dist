import { t as createLucideIcon, r as reactExports, w as useComposedRefs, j as jsxRuntimeExports, x as cn, d as useAuth, c as useActor, g as useQueryClient, k as useAppStore, B as Button, U as Upload$1, l as ue, E as ExternalBlob, T as TrackType, L as Link, I as Input, f as createActor } from "./index-BC7FGAoh.js";
import { B as Badge } from "./badge-BZeS9-HO.js";
import { L as Label } from "./label-vR2P6V67.js";
import { u as useControllableState, P as Primitive, c as composeEventHandlers, a as usePrevious, b as useSize, d as createContextScope, e as useId, f as createCollection, g as useDirection, h as useCallbackRef, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem } from "./select-CBvTfQug.js";
import { P as Presence } from "./index-D7_5Ra33.js";
import { T as Textarea } from "./textarea-DnRd9As0.js";
import { u as useMutation } from "./useMutation-BC-Cd_ED.js";
import { P, a as Pause } from "./wavesurfer.esm-R8E0xR45.js";
import { L as Lock } from "./lock-BWUZVSqD.js";
import { C as CircleCheckBig } from "./circle-check-big-CqRJPSMx.js";
import { T as Trash2 } from "./trash-2-Gxwft81S.js";
import { P as Play } from "./play-DMbJ2Nk8.js";
import "./chevron-up-BMX3-FAd.js";
/**
...
async function withUploadRetry(fn, retries = 3, baseDelayMs = 3e3) {
  let lastErr;
  for (let attempt = 0; attempt <= retries; attempt++) {
    try {
      ...
      lastErr = err;
      const msg = err instanceof Error ? err.message : String(err);
      const isRetryable = msg.toLowerCase().includes("v3") || msg.toLowerCase().includes("certificate") || msg.toLowerCase().includes("response body") || msg.toLowerCase().includes("network") || msg.toLowerCase().includes("failed to fetch") || msg.toLowerCase().includes("canister is stopped");
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 sm:mt-6 card-elevated p-4 sm:p-6 space-y-4 sm:space-y-5", children: [
                  ...
                  uploadMutation.isPending && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center animate-pulse", children: "Uploading your files — this may take a moment for large audio files…" })
                ] })
              ] })
            ]
          }
